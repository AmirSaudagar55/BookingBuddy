    ...
    <div id="features">
      <Container>
        ...
        <div className="mt-16 grid divide-x divide-y divide-gray-100 dark:divide-gray-700 overflow-hidden rounded-3xl border border-gray-100 text-gray-600 dark:border-gray-700 sm:grid-cols-2 lg:grid-cols-4 lg:divide-y-0 xl:grid-cols-4">
          {[...Array(4)].map((_, i) => (
            <div key={i} className={`group relative ${i === 3 ? 'bg-gray-50 dark:bg-gray-900' : 'bg-white dark:bg-gray-800'} transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10`}>
              <div className="relative space-y-8 py-12 p-8 transition duration-300 group-hover:bg-white dark:group-hover:bg-gray-800">
                <img
                  src={`https://cdn-icons-png.flaticon.com/512/4341/4341${139 + i}.png`}
                  className="w-12"
                  width="512"
                  height="512"
